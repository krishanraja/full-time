  ...
  return (
    <>
      <motion.div
        ...
        className="tap surface fixed inset-x-0 bottom-[78px] z-40 mx-auto flex w-[calc(100%-24px)] max-w-[424px] items-center gap-3 overflow-hidden rounded-[var(--radius-xl)] p-2.5 pl-3 text-left backdrop-blur md:bottom-6"
      >
        ...
        >
          ...
          <div className="truncate text-sm font-semibold tracking-tight">
            {episode.format === "daily" ? (
              <>
                {episode.punditName} / {episode.title}
              </>
            ) : (
              <>
                {episode.homeTeam}{" "}
